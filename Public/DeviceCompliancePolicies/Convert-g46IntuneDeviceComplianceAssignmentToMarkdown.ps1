function Convert-g46IntuneDeviceComplianceAssignmentToMarkdown {
<#
.SYNOPSIS
Function to convert a Device Compliance assignment JSON to Markdown format.
.DESCRIPTION
To be used with Export-g46IntuneDeviceComplianceAssignmentDocs
.NOTES
    Author: Joe Loveless
    Version: 1.0.0
#>
