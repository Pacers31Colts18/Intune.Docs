function Export-g46IntuneDeviceHealthScriptsDocs {
    <#
.SYNOPSIS
    Export Intune Device Health Scripts to Markdown.
.DESCRIPTION
...
#>
   ...
   # Main
    ...
    foreach ($policy in $policies) {
        ...
        $md = Convert-g46IntuneDeviceHealthScriptsToMarkdown -Policy $policy -Settings $response
