function Convert-g46IntuneConfigurationPoliciesAssignmentToMarkdown {
<#
.SYNOPSIS
Function to convert a Settings Catalog assignment JSON to Markdown format.
.DESCRIPTION
To be used with Export-g46IntuneConfigurationPoliciesAssignmentDocs
.NOTES
    Author: Joe Loveless
    Version: 1.0.0
#>
