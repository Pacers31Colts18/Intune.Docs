function Export-IntuneDeviceManagementScriptsAssignmentDocs {
    <#
.SYNOPSIS
...
#>
    ...
    foreach ($policy in $policies) {
        ...
        try {
        $md = Convert-IntuneDeviceManagementScriptsAssignmentToMarkdown -Policy $policy -Assignments $assignments
        }
        catch {
