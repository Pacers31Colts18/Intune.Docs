function Convert-IntuneWindowsAutopilotDeploymentProfilesAssignmentToMarkdown {
<#
.SYNOPSIS
Function to convert a Windows Autopilot Deployment Profiles assignment JSON to Markdown format.
.DESCRIPTION
To be used with Export-IntuneWindowsAutopilotDeploymentProfilesAssignmentDocs
.NOTES
    Author: Joe Loveless
    Version: 1.1.1
#>
