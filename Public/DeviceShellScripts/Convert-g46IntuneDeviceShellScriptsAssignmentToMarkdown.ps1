function Convert-g46IntuneDeviceShellScriptsAssignmentToMarkdown {
<#
.SYNOPSIS
Function to convert a Device Shell Script assignment JSON to Markdown format.
.DESCRIPTION
To be used with Export-g46IntuneDeviceShellScriptsAssignmentDocs
.NOTES
    Author: Joe Loveless
    Version: 1.1.1
#>
