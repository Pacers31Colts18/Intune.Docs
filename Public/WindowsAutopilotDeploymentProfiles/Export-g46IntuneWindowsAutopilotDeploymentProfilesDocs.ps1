function Export-g46IntuneWindowsAutopilotDeploymentProfilesDocs {
    <#
.SYNOPSIS
    Export Intune Device Autopilot Deployment Profiles to Markdown.
.DESCRIPTION
...
#>
    ...
    foreach ($policy in $policies) {
        ...
        $md = Convert-g46IntuneWindowsAutopilotDeploymentProfilesToMarkdown -Policy $policy -Settings $response
