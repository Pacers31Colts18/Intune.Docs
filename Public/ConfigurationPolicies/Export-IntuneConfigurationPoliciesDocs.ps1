function Export-IntuneConfigurationPoliciesDocs {
    <#
.SYNOPSIS
...
#>
    ...
    # Retrieve policies
    $policies = Get-IntuneDeviceManagementPolicy -graphendpoint configurationPolicies
    ...
    foreach ($policy in $policies) {
        ...
        $md = Convert-IntuneConfigurationPoliciesToMarkdown -Policy $policy -Settings $settings
