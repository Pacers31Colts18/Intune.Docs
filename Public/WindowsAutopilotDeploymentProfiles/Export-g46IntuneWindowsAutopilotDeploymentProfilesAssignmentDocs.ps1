function Export-g46IntuneWindowsAutopilotDeploymentProfilesAssignmentDocs {
    <#
.SYNOPSIS
    Export Intune Windows Autopilot Deployment Profilesassignments to Markdown
.DESCRIPTION
...
#>
    ...
    $endpoint = "WindowsAutopilotDeploymentProfiles"
    ...
    foreach ($policy in $policies) {
        ...
        $md = Convert-g46IntuneWindowsAutopilotDeploymentProfilesAssignmentToMarkdown -Policy $policy -Assignments $assignments
