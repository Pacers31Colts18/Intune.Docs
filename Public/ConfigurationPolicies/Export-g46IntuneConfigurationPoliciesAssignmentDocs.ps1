function Export-g46IntuneConfigurationPoliciesAssignmentDocs {
    <#
.SYNOPSIS
...
#>
    ...
    foreach ($policy in $policies) {
        ...
        try {
        $md = Convert-g46IntuneConfigurationPoliciesAssignmentToMarkdown -Policy $policy -Assignments $assignments
        }
        catch {
