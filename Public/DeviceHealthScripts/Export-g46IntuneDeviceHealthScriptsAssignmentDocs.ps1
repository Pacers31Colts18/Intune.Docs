function Export-g46IntuneDeviceHealthScriptsAssignmentDocs {
    <#
.SYNOPSIS
...
#>
    ...
    foreach ($policy in $policies) {
        ...
        try {
        $md = Convert-g46IntuneDeviceHealthScriptsAssignmentToMarkdown -Policy $policy -Assignments $assignments
        }
        catch {
