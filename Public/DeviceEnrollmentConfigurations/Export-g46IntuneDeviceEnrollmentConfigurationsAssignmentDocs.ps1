function Export-g46IntuneDeviceEnrollmentConfigurationsAssignmentDocs {
    <#
.SYNOPSIS
...
#>
    ...
    foreach ($group in $groups) {
        ...
        $md = Convert-g46IntuneDeviceEnrollmentConfigurationsAssignmentToMarkdown -Policy $policy -Assignments $assignments
        }
        catch {
