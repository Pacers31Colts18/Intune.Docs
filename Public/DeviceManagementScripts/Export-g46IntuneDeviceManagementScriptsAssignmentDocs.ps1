function Export-g46IntuneDeviceManagementScriptsAssignmentDocs {
    <#
.SYNOPSIS
    Export Intune Device Management Scripts assignments to Markdown
.DESCRIPTION
...
#>
    ...
    foreach ($policy in $policies) {
        ...
        try {
        $md = Convert-g46IntuneDeviceManagementScriptsAssignmentToMarkdown -Policy $policy -Assignments $assignments
        }
        catch {
