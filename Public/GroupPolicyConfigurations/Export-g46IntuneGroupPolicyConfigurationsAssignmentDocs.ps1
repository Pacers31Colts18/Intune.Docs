function Export-g46IntuneGroupPolicyConfigurationsAssignmentDocs {
    <#
.SYNOPSIS
...
#>
    ...
    foreach ($policy in $policies) {
        ...
        $md = Convert-g46IntuneGroupPolicyConfigurationsAssignmentToMarkdown -Policy $policy -Assignments $assignments
