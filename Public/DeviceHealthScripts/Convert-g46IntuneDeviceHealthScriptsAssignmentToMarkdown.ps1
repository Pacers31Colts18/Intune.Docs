function Convert-g46IntuneDeviceHealthScriptsAssignmentToMarkdown {
<#
.SYNOPSIS
Function to convert a Device Health Script assignment JSON to Markdown format.
.DESCRIPTION
To be used with Export-g46IntuneDeviceHealthScriptsAssignmentDocs
.NOTES
    Author: Joe Loveless
    Version: 1.0.0
#>
