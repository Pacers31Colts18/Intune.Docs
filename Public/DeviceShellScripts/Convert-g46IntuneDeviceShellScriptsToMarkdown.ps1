function Convert-g46IntuneDeviceShellScriptsToMarkdown {
<#
.SYNOPSIS
Function to convert an Intune Device Shell Script JSON to Markdown format.
.DESCRIPTION
To be used with Export-g46IntuneDeviceShellScriptDocs
.NOTES
    Author: Joe Loveless
    Version: 1.0.0
#>
