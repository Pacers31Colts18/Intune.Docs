function Export-IntuneWindowsAutopilotDeploymentProfilesDocs {
    <#
.SYNOPSIS
...
#>
    ...
    foreach ($policy in $policies) {
        ...
        $md = Convert-IntuneWindowsAutopilotDeploymentProfilesToMarkdown -Policy $policy -Settings $response
