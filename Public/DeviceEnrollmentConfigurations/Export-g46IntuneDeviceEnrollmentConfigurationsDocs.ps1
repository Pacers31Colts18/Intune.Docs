function Export-g46IntuneDeviceEnrollmentConfigurationsDocs {
<#
.SYNOPSIS
...
#>
    ...
    foreach ($group in $groups) {
        ...
        $md = Convert-g46IntuneDeviceEnrollmentConfigurationsToMarkdown -PolicyGroup $group.Group -Settings $settings
