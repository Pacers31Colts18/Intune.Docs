function Convert-g46IntuneDeviceManagementScriptsAssignmentToMarkdown {
<#
.SYNOPSIS
Function to convert a Device Management Script assignment JSON to Markdown format.
.DESCRIPTION
To be used with Export-g46IntuneDeviceManagementScriptsAssignmentDocs
.NOTES
    Author: Joe Loveless
    Version: 1.0.0
#>
